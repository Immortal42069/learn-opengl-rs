...
pub fn main_2_4_2() {
    ...
    let (lightingShader, lampShader, VBO, cubeVAO, lightVAO, diffuseMap, specularMap) = unsafe {
        ...
        // ------------------------------------
        let lightingShader =
            Shader::new("src/_2_lighting/shaders/4.2.lighting_maps.vs", "src/_2_lighting/shaders/4.2.lighting_maps.fs");
        let lampShader = Shader::new("src/_2_lighting/shaders/4.2.lamp.vs", "src/_2_lighting/shaders/4.2.lamp.fs");
