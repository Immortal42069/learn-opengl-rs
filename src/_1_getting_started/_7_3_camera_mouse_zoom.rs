...
pub fn main_1_7_3() {
    ...
    let (ourShader, VBO, VAO, texture1, texture2, cubePositions) = unsafe {
        ...
        // ------------------------------------
        let ourShader =
            Shader::new("src/_1_getting_started/shaders/7.3.camera.vs", "src/_1_getting_started/shaders/7.3.camera.fs");
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let view: Matrix4<f32> = Matrix4::look_at_rh(cameraPos, cameraPos + cameraFront, cameraUp);
